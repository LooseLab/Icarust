...
use device::device_service_server::DeviceService;
use tonic::{Request, Response, Status};
use device::get_flow_cell_info_response::TemperatureOffsetNullable;
...
impl DeviceService for Device {
    ...
    async fn get_flow_cell_info(
        ...
        Ok(Response::new(device::GetFlowCellInfoResponse {has_flow_cell:true,channel_count:512,wells_per_channel:4,flow_cell_id:"slow_poke".to_string(),asic_id_str:"help_me".to_string(),product_code:"please".to_string(),user_specified_flow_cell_id:"".to_string(),user_specified_product_code:"".to_string(),has_adapter:false,adapter_id:"".to_string(),asic_version:"".to_string(),
